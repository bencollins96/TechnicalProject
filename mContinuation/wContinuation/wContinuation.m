...
[t,y,poincare] = numericalSolution([-0.0175746499136655,0.206010296683050,-0.0670264019030084,0.603312702379156,mod(20696.8124018496,2*pi)],params,tSpan);
IC = poincare(end,:);
Ic = 
...
numIterates =400;
paramVec = linspace(1.9,20,numIterates);
